...
| [legacy](https://github.com/wui-js/wuijs-main-lib/tree/main/legacy/)                         | Deprecated fonts with previous versions. |
| [legacy/wui-js](https://github.com/wui-js/wuijs-main-lib/tree/main/legacy/wui-js/)           | WUI/JS Project directory. |
| [legacy/wui-js/main](https://github.com/wui-js/wuijs-main-lib/tree/main/legacy/wui-js/main/) | WUI/JS Main library (version prior to 0.4.0). |
