...
class WUITable {
	...
	#updateFiller() {
		const htmlElement = this.#htmlElement;
		const { table, thead } = this.#htmlElements;
		if (!(htmlElement instanceof HTMLDivElement) || !(table instanceof HTMLTableElement)) return;
