...
class WUIScrolly {
	...
	init() {
		...
		const hasScrollJS = this.#properties.sections.length > 0 || (typeof (this.#properties.onStart) == "function" || typeof (this.#properties.onMove) == "function" || typeof (this.#properties.onStop) == "function");
		if (hasScrollJS) {
