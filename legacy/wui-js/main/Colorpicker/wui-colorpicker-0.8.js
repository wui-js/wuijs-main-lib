...
class WUIColorpicker {
	...
	#loadHTML() {
		...
		this.#htmlElements.input = document.querySelector(sel + " > input[type='color']");
		this.#htmlElements.opener = document.querySelector(sel + " > .opener");
		this.#htmlElements.button = document.querySelector(sel + " > .button");
		this.#htmlElements.buttonColor = document.querySelector(sel + " > .button > .color");
		this.#htmlElements.overlay = document.querySelector(sel + " > .overlay");
		this.#htmlElements.box = document.querySelector(sel + " > .box");
		this.#htmlElements.header = document.querySelector(sel + " > .box > .header");
		this.#htmlElements.gridTab = document.querySelector(sel + " > .box > .header > .tab.grid");
		this.#htmlElements.listTab = document.querySelector(sel + " > .box > .header > .tab.list");
		this.#htmlElements.grid = document.querySelector(sel + " > .box > .grid");
		this.#htmlElements.list = document.querySelector(sel + " > .box > .list");
		this.#htmlElements.preview = document.querySelector(sel + " > .box > .preview");
		this.#htmlElements.previewColor = document.querySelector(sel + " > .box > .preview > .color");
		this.#htmlElements.previewText = document.querySelector(sel + " > .box > .preview > .text");
	...
	init() {
		...
		if (this.#htmlElement instanceof HTMLDivElement && this.#htmlElements.input instanceof HTMLInputElement) {
			...
			this.#htmlElements.grid.innerHTML = "";
			...
			this.#htmlElements.gridTab.classList.add("selected");
			...
			this.#htmlElements.list.classList.add("hidden");
