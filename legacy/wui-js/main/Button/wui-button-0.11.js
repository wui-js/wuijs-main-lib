...
class WUIButton {
	...
	#loadHTML() {
		...
		if (this.#htmlElement instanceof HTMLButtonElement) {
			...
			if (htmlElements.iconClassBox) {
				this.iconClass = htmlElements.iconClassBox.className;
			}
			if (htmlElements.iconImgageBox) {
				this.iconImage = htmlElements.iconImgageBox.src;
			}
			if (htmlElements.textBox) {
				const span = htmlElements.textBox;
	...
	getIcon() {
		return this.#htmlElements.iconClassBox || this.#htmlElements.iconImgageBox;
	}
